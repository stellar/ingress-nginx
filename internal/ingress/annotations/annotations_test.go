...
func TestCustomResponseHeaders(t *testing.T) {
	...
	fooAnns := []struct {
		...
		{map[string]string{annotationCustomResponseHeaders: "Content-Type: application/json || Accept: application/json"}, map[string]string{"Content-Type": "application/json", "Accept": "application/json"}},
		{map[string]string{annotationCustomResponseHeaders: "Content-Type application/json || Accept: application/json"}, map[string]string{}},
		{nil, map[string]string{}},
	}

	for _, foo := range fooAnns {
		ing.SetAnnotations(foo.annotations)
		r := ec.Extract(ing).CustomResponseHeaders.ResponseHeaders
